...
public class ManageAuteurWindow extends JFrame {
    ...
    private void supprimerAuteur() {
        ...
        if (option == JOptionPane.YES_OPTION) {
            try {
                ...
                PreparedStatement deleteStmt = con.prepareStatement("DELETE FROM auteur WHERE id_auteur = ?");
                deleteStmt.setInt(1, selectedAuthorId);
